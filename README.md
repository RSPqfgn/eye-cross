...
- [Cloth Config](https://modrinth.com/mod/cloth-config)（≥26.2.155，配置文件与配置界面的运行依赖）

**联动模组：**

- [Mod Menu](https://modrinth.com/mod/modmenu)（≥20.0.0，在模组菜单中打开 Eye Cross 配置界面）
...
| `mc-26.2` | 26.2      | 0.19.5        | 0.160.0+26.2   | `eye-cross-fabric-1.2.0-26.2.jar`   |
...
产物命名规则：`<模组名>-fabric-<模组版本>-<Minecraft版本>.jar`，例如 `eye-cross-fabric-1.2.0-26.2.jar`；sources jar 同名加 `-sources` 后缀。各分支的版本对应关系见上表。
